...
const MapComponent: React.FC<MapComponentProps> = ({ searchResult }) => {
  ...
  const initializeMap = () => {
    ...
    map.current = new mapboxgl.Map({
      ...
      center: [38.7578, 9.0320], // Addis Ababa center
      zoom: 12,
      pitch: 45,
      bearing: 0
    });
        ...
        <div className="text-center space-y-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-6">
              To view the interactive map with taxi hubs and routes, please enter your Mapbox public token.
            </p>
          </div>
            ...
            <div className="absolute top-4 right-4 bg-card/90 backdrop-blur-sm rounded-lg p-4 border border-border/50 animate-slide-in-right max-w-xs">
              <div className="space-y-3">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-semibold text-foreground">{searchResult.route}</span>
                </div>
                <div className="space-y-1 text-sm">
                  <p className="text-foreground font-medium">{searchResult.pickup}</p>
                  <p className="text-muted-foreground">{searchResult.landmark}</p>
