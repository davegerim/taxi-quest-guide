          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Smart Taxi Hub Finder</p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">
              Find Your
              <span className="bg-gradient-to-r from-fermata-teal to-fermata-teal-light bg-clip-text text-transparent"> Perfect </span>
              Taxi Hub
            </h2>
            <p className="text-xl text-muted-foreground leading-relaxed">
              Never miss your ride again. Fermata helps you find the nearest taxi pickup points 
              for shared routes in your city, with offline support and real-time directions.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Built specifically for cities with shared taxi systems, Fermata bridges the gap 
              between passengers and fixed-route transportation.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center space-y-4">
              ...
              <h4 className="text-xl font-semibold text-foreground">Enter Your Route</h4>
              <p className="text-muted-foreground">
                Simply input your starting location and destination to begin your search.
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <h4 className="text-xl font-semibold text-foreground">Get Pickup Info</h4>
              <p className="text-muted-foreground">
                Receive detailed information about the nearest taxi hub with landmarks and directions.
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <h4 className="text-xl font-semibold text-foreground">Navigate & Ride</h4>
              <p className="text-muted-foreground">
                Follow walking directions to your pickup point and catch your shared taxi.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-fermata-teal to-fermata-teal-light">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Join thousands of commuters who've made their daily travel smoother with Fermata.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button variant="secondary" size="lg" className="bg-white text-fermata-teal hover:bg-white/90">
      ...
      <footer className="bg-card border-t border-border/50 py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground text-sm">
                Smart taxi hub finder for cities with shared transportation systems.
              </p>
            </div>
          ...
          <div className="border-t border-border/50 mt-8 pt-8 text-center text-sm text-muted-foreground">
            <p>&copy; 2024 Fermata. All rights reserved. Making urban mobility accessible for everyone.</p>
          </div>
        </div>
      </footer>
    </div>
